...
const loginSchema = checkSchema({
  email: { isEmail: true, notEmpty: true, escape: true },
...
const updateUserSchema = checkSchema({
  firstName: {optional: true, isString: true, notEmpty: true, escape: true},
  lastName: { optional: true, isString: true, notEmpty: true, escape: true },
  password: {
    isString: true,
    optional: true,
    matches: { options: { source: /(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}/ } },
