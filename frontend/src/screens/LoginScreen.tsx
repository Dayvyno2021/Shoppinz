        ...
        <div id='register' className="custom__form mx-auto">
          ...
          <form onSubmit={handleFormLogin} className="flex flex-col gap-4">
            <div className="form__control">
              ...
              <input type="email" required id='email' placeholder='enter email' className='' value={email}
                onChange={(e)=>setEmail(e.target.value)} 
              />
            </div>
            <div className="form__control">
              <label htmlFor="password" className=''>Password</label>
              <input type={passwordVisible ? 'text' : 'password'} required id='password' placeholder='password' className='' value={password}
