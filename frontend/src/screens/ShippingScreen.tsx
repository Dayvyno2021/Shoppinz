        ...
        <div id='register' className="custom__form mx-auto">
          ...
          <form onSubmit={submitHanlder} className="flex flex-col gap-4">
            <div className="form__control">
              ...
              <input type="address" required id='address' name='address' placeholder='Address' className='' value={inputs.address}
                onChange={handleInputChange} 
              />
            </div>
            <div className="form__control">
              <label htmlFor="city" className=''>City</label>
              <input type="city" required id='city' name='city' placeholder='City' className='' value={inputs.city}
                onChange={handleInputChange} 
              />
            </div>
            <div className="form__control">
              <label htmlFor="postalCode" className=''>Postal Code</label>
              <input type="postalCode" required id='postalCode' name='postalCode' placeholder='Postal Code' className='' value={inputs.postalCode}
                onChange={handleInputChange} 
              />
            </div>
            <div className="form__control">
              <label htmlFor="country" className=''>Country</label>
              <input type="country" required id='country' name='country' placeholder='Country' className='' value={inputs.country}
                onChange={handleInputChange} 
              />
            </div>
