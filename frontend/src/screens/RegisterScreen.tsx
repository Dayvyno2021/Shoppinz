    ...
    <div className='min-h-[75vh] flex justify-center'>
      <div id='register' className="custom__form">
        ...
        <div className="form__control">
          ...
          <input type="text" required id='fn' placeholder='firstname' autoComplete='false' className='' value={firstName}
            onChange={(e)=>setFirstName(e.target.value)}
          />
        </div>
        <div className="form__control">
          <label htmlFor="ln" className=''>Last Name</label>
          <input type="text" required id='ln' placeholder='last name' className='' value={lastName} autoComplete='false'
            onChange={(e)=>setLastName(e.target.value)}
          />
        </div>
        <div className="form__control">
          <label htmlFor="email" className=''>Email</label>
          <input autoComplete='false' type="email" required id='email' placeholder='enter email' className='' value={email}
